...
import ImageOptionField from 'components/ImageOptionField';

import i18n from 'i18n';
import PropTypes from 'prop-types';

class ImageOptionsetField extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <ul>
                { this.props.source.map((item, index) => (
                    <li><ImageOptionField {...this.getOptionProps(item, index)} hideLabels /></li>
                )) }
            </ul>
        );
    }
...
export { ImageOptionsetField as Component };

export default fieldHolder(ImageOptionsetField);
